    ...
    <section className="bg-white py-28 lg:py-36 border-y border-black/5">
      <div className="max-w-[1280px] mx-auto px-6 lg:px-12">
        ...
        <div className="mt-16 text-center">
          <a
            href="/concierge"
            data-analytics-id="standard:cta:concierge"
            className="inline-flex items-center gap-2 text-[12px] tracking-[0.18em] uppercase text-black hover:text-gold border-b border-black hover:border-[var(--gold)] pb-1 transition"
          >
            Talk to an advisor
          </a>
        </div>
