...
export function StayModule() {
  return (
    <section className="bg-[#f6f3ee] py-24 lg:py-32 border-y border-black/5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.15fr] gap-12 lg:gap-16 items-center">
          <div>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-x-6 gap-y-2 text-[12px] text-black/55">
              <span className="inline-flex items-center gap-2"><Sparkles size={14} className="text-[#c8a96a]" /> Complimentary upgrades</span>
              <span className="inline-flex items-center gap-2"><Sparkles size={14} className="text-[#c8a96a]" /> $100 property credit</span>
              <span className="inline-flex items-center gap-2"><Sparkles size={14} className="text-[#c8a96a]" /> Daily breakfast for two</span>
            </div>
          </div>

          <div className="bg-white border border-black/10 p-6 lg:p-8 shadow-[0_30px_80px_-40px_rgba(0,0,0,0.25)]">
            ...
            <div className="space-y-4">
              <label className="block">
                ...
                <div className="mt-2 flex items-center gap-3 border-b border-black/15 focus-within:border-black pb-2">
                  ...
                  <input
                    placeholder="Tokyo, Paris, Maldives…"
              ...
              <button
                data-analytics-id="home:stay-module:search"
                className="w-full mt-2 flex items-center justify-center gap-2 bg-black text-white py-4 text-[12px] tracking-[0.2em] uppercase hover:bg-[#c8a96a] hover:text-black transition"
              >
                <Search size={14} />
                Search audited stays
              </button>
